...
$router->post('/get-khung-gio-trong', [DatsanController::class, 'getKhungGioTrong']);
...
// Routes cho đặt sân cố định
$router->get('datsan/dat-co-dinh', [DatsanController::class, 'showDatCoDinhForm']);
$router->post('datsan/kiem-tra-co-dinh', [DatsanController::class, 'handleKiemTraCoDinh']);
$router->post('datsan/luu-tam-dat-co-dinh', [DatsanController::class, 'luuTamDatCoDinh']);
...
$router->get('admin/booking-details', 'AdminController@bookingDetails');
...
$router->get('admin/nhan-vien', 'AdminController@quanLyNhanVien');
$router->get('admin/nhan-vien/them', 'AdminController@hienThiThemNhanVien');
$router->post('admin/nhan-vien/xu-ly-them', 'AdminController@xuLyThemNhanVien');
$router->post('admin/nhan-vien/xoa', 'AdminController@xuLyXoaNhanVien');
...
$router->get('user/booking-details', 'UserController@bookingDetails');
